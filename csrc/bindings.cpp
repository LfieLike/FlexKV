  ...
  py::class_<flexkv::LayerwiseTransferGroup>(m, "LayerwiseTransferGroup")
      ...
      .def(
          py::init<
              ...
              const std::vector<int> &, const std::vector<int64_t> &,
              ...
              const std::vector<int64_t> &, const std::vector<int64_t> &,
              const std::vector<int64_t> &, const std::vector<int64_t> &,
              const std::vector<int64_t> &, const std::vector<int64_t> &, int,
          ...
          py::arg("group_ssd_offset_bytes"),
          py::arg("group_cpu_layer_strides"),
          py::arg("group_cpu_kv_strides"),
          py::arg("group_ssd_layer_strides"),
          py::arg("group_ssd_kv_strides"), py::arg("group_chunk_sizes"),
          py::arg("group_h2d_cpu_kv_strides"),
          py::arg("group_h2d_cpu_layer_strides"),
          py::arg("group_cpu_block_strides"),
          py::arg("group_cpu_tp_strides"), py::arg("group_gpu_kv_strides"),
          py::arg("group_gpu_block_strides"),
          py::arg("group_gpu_layer_strides"),
          py::arg("group_gpu_chunk_sizes"), py::arg("iouring_entries"),
          py::arg("iouring_flags"), py::arg("layer_eventfds_tensor"),
          py::arg("tp_size"))
      ...
      .def("layerwise_transfer_multi_group",
           ...
           py::arg("num_threads_per_device"),
           py::arg("gpu_block_id_tensor"), py::arg("cpu_block_id_tensor"),
           py::arg("transfer_cta_num"), py::arg("use_ce_transfer"),
           py::arg("is_mla"), py::arg("counter_id") = 0,
           py::arg("notify_mode") = "hostfunc");
#ifdef FLEXKV_ENABLE_CFS
